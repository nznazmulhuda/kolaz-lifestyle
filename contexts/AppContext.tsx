...
export const validateCoupon = (code: string): { isValid: boolean; discount: number; message: string } => {
  const validCoupons = {
  ...
  if (validCoupons[code as keyof typeof validCoupons]) {
    ...
    return { isValid: true, discount: coupon.discount, message: coupon.message }
  }
